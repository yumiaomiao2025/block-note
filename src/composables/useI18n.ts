...
const translations: Record<Language, Translations> = {
  zh: {
    ...
    tagManager: {
      ...
      tagsCount: '标签',
      tagGroupSortSettings: '标签组排序设置',
      tagGroupSort: '标签组排序',
      tagInGroupSort: '组内标签排序',
      sortCustom: '自定义排序',
      sortName: '按字母',
      sortUsage: '按使用频率',
    },
  ...
  en: {
    ...
    tagManager: {
      ...
      tagsCount: 'tags',
      tagGroupSortSettings: 'Tag Group Sort Settings',
      tagGroupSort: 'Tag Group Sort',
      tagInGroupSort: 'Tags in Group Sort',
