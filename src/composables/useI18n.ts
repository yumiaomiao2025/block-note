...
const translations: Record<Language, Translations> = {
  zh: {
    ...
    placeholder: {
      ...
      searchTemplatesAndGroups: '搜索模板和模板组...',
      newTemplateGroupName: '新模板组名称...',
      untitled: '无标题',
    ...
    templateManager: {
      ...
      changeGroup: '更改组',
      createTemplateGroup: '创建模板组',
      deleteTemplateGroup: '删除模板组',
      renameTemplateGroup: '重命名模板组',
      templateGroupSort: '模板组排序',
      templateInGroupSort: '组内排序',
      sortSettings: '排序设置',
      newTemplateGroupName: '新模板组名称',
      deleteTemplateGroupConfirm: '确定要删除模板组"{name}"吗？',
      deleteTemplateGroupWithTemplates: '该组包含 {count} 个模板。删除后，这些模板将移动到"通用"组。',
      deleteTemplateGroupNoTemplates: '该组目前没有模板。',
    },
    lightTagSettings: {
      title: '轻标签显示设置',
      displayLimit: '显示限制',
  ...
  en: {
    ...
    placeholder: {
      ...
      searchTemplatesAndGroups: 'Search templates and groups...',
      newTemplateGroupName: 'New template group name...',
      untitled: 'Untitled',
